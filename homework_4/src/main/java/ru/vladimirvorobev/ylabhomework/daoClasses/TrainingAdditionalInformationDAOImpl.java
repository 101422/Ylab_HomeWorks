...
public class TrainingAdditionalInformationDAOImpl implements TrainingAdditionalInformationDAO {
    ...
    public List<TrainingAdditionalInformation> findByTraining(Training training) {
        return jdbcTemplate.query(GET_TRAINING_ADDITIONAL_INFORMATION_BY_TRAINING_ID, new Object[]{training.getId()}, new BeanPropertyRowMapper<>(TrainingAdditionalInformation.class));
    }
    ...
    public void save(TrainingAdditionalInformation trainingAdditionalInformation, Training training) {
        jdbcTemplate.update(SAVE_TRAINING_ADDITIONAL_INFORMATION, trainingAdditionalInformation.getKey(), trainingAdditionalInformation.getValue(), training.getId());
    }
