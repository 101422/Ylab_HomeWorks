...
public class TrainingDAOImpl implements TrainingDAO {
    ...
    public List<Training> findAll() {
        return jdbcTemplate.query(SQLQueryConstants.GET_ALL_TRAININGS, resultSet -> {
    ...
    public List<Training> findByPerson(Person person) {
        return  jdbcTemplate.query(SQLQueryConstants.GET_TRAININGS_BY_PERSON_ID, new Object[]{person.getId()}, resultSet -> {
            List<Training> trainings = new LinkedList<>();
    ...
    public Optional<Training>  findByPersonAndTrainingTypeAndDate(Person person, TrainingType trainingType, Date date) {
        return  jdbcTemplate.query(SQLQueryConstants.GET_TRAINING_BY_PERSON_ID_AND_TRAINING_TYPE_ID_AND_DATE, new Object[]{person.getId(), trainingType.getId(), date}, resultSet -> {
            Training training = null;
    ...
    public Optional<Training> findById(int id) {
        return  jdbcTemplate.query(SQLQueryConstants.GET_TRAINING_BY_ID, new Object[]{id}, resultSet -> {
            Training training = null;
    ...
    public void save(Training training) {
        jdbcTemplate.update(SQLQueryConstants.SAVE_TRAINING, training.getDate(), training.getDuration(), training.getAmountOfCalories(), training.getPerson().getId(), training.getTrainingType().getId());
    }
    ...
    public void update(int id, Training training) {
        jdbcTemplate.update(SQLQueryConstants.UPDATE_TRAINING, training.getDate(), training.getDuration(), training.getAmountOfCalories(), training.getPerson().getId(), training.getTrainingType().getId(), training.getId());
    }
    ...
    public void delete(int id) {
        jdbcTemplate.update(SQLQueryConstants.DELETE_TRAINING, id);
    }
    ...
    public void deleteAll() {
        jdbcTemplate.update(SQLQueryConstants.DELETE_ALL_TRAININGS);
    }
