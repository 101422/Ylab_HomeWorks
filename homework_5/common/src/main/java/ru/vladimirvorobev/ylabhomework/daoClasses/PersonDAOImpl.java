...
public class PersonDAOImpl implements PersonDAO {
    ...
    public Optional<Person> findByName(String name) {
        return jdbcTemplate.query(SQLQueryConstants.GET_PERSON_BY_NAME, new Object[]{name}, new BeanPropertyRowMapper<>(Person.class))
                .stream().findAny();
    }
    ...
    public void save(Person person) {
        jdbcTemplate.update(SQLQueryConstants.SAVE_PERSON, person.getName(), person.getPassword(), person.getRole().toString());
    }
    ...
    public void deleteAll() {
        jdbcTemplate.update(SQLQueryConstants.DELETE_ALL_PERSONS);
    }
}
