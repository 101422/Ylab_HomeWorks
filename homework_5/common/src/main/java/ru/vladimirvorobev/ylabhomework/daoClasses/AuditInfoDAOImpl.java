...
public class AuditInfoDAOImpl implements AuditInfoDAO {
    ...
    public List<AuditInfo> findAll() {
        return jdbcTemplate.query(SQLQueryConstants.GET_ALL_AUDIT_INFO, new BeanPropertyRowMapper<>(AuditInfo.class));
    }
    ...
    public void save(AuditInfo auditInfo) {
        jdbcTemplate.update(SQLQueryConstants.SAVE_AUDIT_INFO, auditInfo.getEvent(), auditInfo.getTimestamp());
    }
    ...
    public void deleteAll() {
        jdbcTemplate.update(SQLQueryConstants.DELETE_ALL_AUDIT_INFO);
    }
